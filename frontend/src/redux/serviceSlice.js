  ...
  export const serviceSlice = createSlice({
    ...
    extraReducers(builder) {
      //addcase get
        ...
        //   const index = state.findIndex(service => service.id === serviceupdate.id);
        //   if (index !== -1) {
        //     state[index] = serviceupdate;
        //   }
        })
...
export const{toggleTrue,toggleFalse,togglesearch}= serviceSlice.actions
